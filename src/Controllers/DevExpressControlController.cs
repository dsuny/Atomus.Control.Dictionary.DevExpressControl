...
{
    internal static class DevExpressControlController
    {
        internal static async Task<IResponse> SearchAsync(this ICore core, DevExpressControlSearchModel search, ICore parentCore)
        {
        ...
        internal static IResponse Search(this ICore core, DevExpressControlSearchModel search, ICore parentCore)
        {
            IServiceDataSet serviceDataSet;
            IResponse result;
            string tmp;
